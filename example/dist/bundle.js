...
/***/ function(module, exports, __webpack_require__) {
	...
	var RenderFunction_1 = __webpack_require__(68);
	var RenderString_1 = __webpack_require__(70);
	var RenderTemplateUrl_1 = __webpack_require__(71);
	var ConnectExample_1 = __webpack_require__(72);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = (React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, 
	    React.createElement(react_router_1.Route, {path: "/", component: ConnectExample_1.ConnectExample}, 
	        React.createElement(react_router_1.Route, {path: "function", component: RenderFunction_1.RenderFunction}), 
	        React.createElement(react_router_1.Route, {path: "string", component: RenderString_1.RenderString}), 
	        React.createElement(react_router_1.Route, {path: "url", component: RenderTemplateUrl_1.RenderTemplateUrl}))
	));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RenderFunction = (function (_super) {
	    __extends(RenderFunction, _super);
	    function RenderFunction(props) {
	        _super.call(this, props);
	    }
	    RenderFunction.prototype.onIncreaseClick = function (event) {
	        console.log(event);
	    };
	    RenderFunction = __decorate([
	        Render_1.Render({
	            template: function () {
	                return React.createElement("div", null, 
	                    React.createElement("p", null, this.props.count), 
	                    React.createElement("button", {onClick: this.props.onIncreaseClick}, "点击"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Render_1 = __webpack_require__(69);
	var RenderString = (function (_super) {
	    __extends(RenderString, _super);
	    function RenderString(props) {
	        _super.call(this, props);
	    }
	    RenderString.prototype.onIncreaseClick = function (event) {
	        console.log(event);
	    };
	    RenderString = __decorate([
	        Render_1.Render({
	            template: function () {
	                return React.createElement("div", null, 
	                    React.createElement("p", null, this.props.count), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Render_1 = __webpack_require__(69);
	var RenderTemplateUrl = (function (_super) {
	    __extends(RenderTemplateUrl, _super);
	    function RenderTemplateUrl(props) {
	        _super.call(this, props);
	    }
	    RenderTemplateUrl.prototype.onIncreaseClick = function (event) {
	        console.log(event);
	    };
	    RenderTemplateUrl = __decorate([
	        Render_1.Render({
	            template: React.createElement("ul", null, 
	                React.createElement("li", null, 
	                    "Hello from Url", 
	                    this.props.compiler), 
	                React.createElement("li", null, "testste"))
	        })
	    ], RenderTemplateUrl);
	    return RenderTemplateUrl;
	}(React.Component));
	exports.RenderTemplateUrl = RenderTemplateUrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Render_1 = __webpack_require__(69);
	var Connect_1 = __webpack_require__(73);
	var ConnectExample = (function (_super) {
	    __extends(ConnectExample, _super);
	    function ConnectExample(props) {
	        _super.call(this, props);
	    }
	    ConnectExample.prototype.onIncreaseClick = function (event) {
	        console.log(event);
	    };
	    ConnectExample = __decorate([
	        Connect_1.Connect(['count'], [{ onIncreaseClick: { type: "increase" } }]),
	        Render_1.Render({
	            template: function () {
	                return React.createElement("div", null, 
	                    React.createElement("p", null, this.props.count), 
	                    React.createElement("button", {onClick: this.props.onIncreaseClick}, "Click"), 
	                    React.createElement("h1", null, 
	                        "Hello from ", 
	                        this.props.compiler, 
	                        " and ", 
	...
	exports.ConnectExample = ConnectExample;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer_1 = __webpack_require__(115);
	exports.store = redux_1.createStore(reducer_1.Counter);
